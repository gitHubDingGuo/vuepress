...
import type { ResolvedSidebarItem } from '@vuepress/theme-default/lib/shared/index.js'
import { isActiveSidebarItem } from '@vuepress/theme-default/lib/client/utils/index.js'
...
<template>
  <li>
    ...
    <DropdownTransition v-if="item.children?.length && item.sidebarDepth!=10">
